...
<body>
	...
	<%
		...
		dim_parametros_medicion mp = new dim_parametros_medicion();
	%>
	<form action="verParametrosUpdates.jsp" method="post" action="/action_page.php">
		<table>
			<tr>
				<td><label for="sk_parametros_medicion">sk_parametros_medicion:</label></td>
				<td><input type="text" name="sk_parametros_medicion" value="<%=mp.getSk_parametros_medicion()%>" id="txtid" required/></td>
			</tr>
			<tr>
				<td><label for="parametro">parametro:</label></td>
				<td><input type="text" name="parametro" value="<%=mp.getParametro()%>" id="txtid" required/></td>
			</tr>
			<tr>
				<td><label for="unidad_medida">unidad_medida:</label></td>
				<td><input type="text" name="unidad_medida" value="<%=mp.getUnidad_medida()%>" id="txtid" required/></td>
			</tr>
			<tr>
