...
<body>
	...
	<center><hr/><h1>Dimension Criterios de Calidad</h1><hr/></center>
	<center>
	<%
		dim_criterios_calidad criterio = new dim_criterios_calidad();
		String tabla = criterio.verCriterios();
		out.print(tabla);
	%>
	<br>
	<a href="resources/graficas/r_dim_criterios_g.jsp">GRAFICAS</a>
	</center>
