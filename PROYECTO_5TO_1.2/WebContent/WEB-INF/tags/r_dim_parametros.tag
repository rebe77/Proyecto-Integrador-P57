...
<body>
	...
	<center><hr/><h1>Dimension Parametros de Medicion</h1><hr/></center>
	<center>
	<%
		dim_parametros_medicion criterio = new dim_parametros_medicion();
		String tabla = criterio.verParametros();
		out.print(tabla);
	%>
	<br>
	<a href="resources/graficas/r_dim_parametros_g.jsp">GRAFICAS</a>
	</center>
