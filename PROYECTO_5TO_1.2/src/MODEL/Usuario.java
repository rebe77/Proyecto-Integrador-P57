...
public class Usuario {
	...
	public String verUsuario(){
		String sql = "SELECT * FROM usuario.usuario ORDER BY id_per, nombres";
		Conexion con = new Conexion();
		String tabla = "<table id=\"testTable\" border=2> <th>cedula</th> <th>id_per</th> <th>nombre</th> <th>apellido</th> <th>telefono</th> <th>correo</th>";
		ResultSet rs = null;
		rs = con.Consulta(sql);
		try {
			while (rs.next()){
